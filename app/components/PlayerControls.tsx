...
export function PlayerControls() {
  const { currentTrack, isPlaying, currentTime, volume, togglePlay, next, previous, seek, setVolume } = usePlayer();
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#0a0a0a] border-t border-[#1a1a1a] px-6 py-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-3">
          <div
            className="h-1 bg-[#1a1a1a] rounded-full cursor-pointer group relative"
            onClick={handleSeek}
          >
            <div
              className="h-full bg-[#e5e5e5] rounded-full relative group-hover:bg-white transition-colors"
